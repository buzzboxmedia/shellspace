...
private let logger = Logger(subsystem: "com.buzzbox.claudehub", category: "ProcessMonitor")
...
final class ProcessMonitor {
    ...
    private let queue = DispatchQueue(label: "com.buzzbox.claudehub.processmonitor", qos: .utility)
